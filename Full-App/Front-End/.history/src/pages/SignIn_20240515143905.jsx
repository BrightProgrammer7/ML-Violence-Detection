													...
													<div>
														...
														<div className="mb-4">
															...
															<input
																...
																// }`}
																className="border border-slate-700 text-sm rounded-lg focus:ring-primary bg-slate-700 dark:text-neutral-200 block w-full p-2.5"
										...
										<div className="flex-box rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-gradient-to-r from-blue-500 to-green-300">
											<div className="flex-box flex-col px-4 py-6 text-white md:mx-6 md:p-12">
												<h4 className="mb-6 text-xl font-semibold">
													We are more than just Engineer
												</h4>
												<p className="text-sm">
													We Are Students
												</p>
