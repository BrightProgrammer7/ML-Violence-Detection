  ...
  return (
    <div className="container mx-auto max-w-lg">
      ...
      {!processedImage ? (
        ...
        <div className="p-4 border border-gray-300">
          <label className="block text-gray-700 font-bold mb-2" htmlFor="without_post_proccessing">Scene Detected: </label>
          
          <div className="aspect-w-16 aspect-h-9">
          <img  className="object-cover w-full h-full" width={100} src={processedImage} alt="Processed" />
          </div>
        </div>
      )}
    </div>
