              ...
              <div className="d-flex-box">
                <div className="px-6 text-center text-white md:px-12 font-Bruno d-flex-box flex-column opacity-100">
                  <div className="wlcm mb-6 text-8xl font-weight-900 text-transparent bg-clip-text ">
                    Welcome <br /> to
                    <h2 className="text-5xl supt drop-shadow-sm shadow-black bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparentpb-6 font-extrabold sm:text-5xl">
                    Vigilant
