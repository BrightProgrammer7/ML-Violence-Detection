            ...
            <div className="d-flex-box w-100 overflow-hidden opacity-100">
              <div className="d-flex-box">
                <div className="px-6 text-center text-white md:px-12 font-Bruno d-flex-box flex-column opacity-100">
                  ...
                  <div className="mb-8 flex-box border rounded-lg shadow-lg shadow-sm--hover shadowred z-100 cursor-pointer inline-flex transition ease-linear text-base font-weight-normal text-center text-white bg-info hover-bg-hot-pink">
                    <a
                      onClick={handleStart}
